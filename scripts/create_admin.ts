...
async function createAdmin() {
  ...
  if (!authUser) {
      // ... create auth user logic (omitted for brevity as we know it exists)
      console.log('User not found in Auth (unexpected based on logs). Creating...');
  ...
  if (publicUser && publicUser.id !== authUser.id) {
      ...
      else console.log('Unlinked objectives.');
